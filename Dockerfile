...
COPY ["Authorization.Entity/Authorization.Entity.csproj", "Authorization.Entity/"]
COPY ["Authorization.Infraestructure/Authorization.Infraestructure.csproj", "Authorization.Infraestructure/"]
